...
AI_ICON = "images/multivac-stacked-logo-2023.jpg"
...
def write_top_bar():
    ...
    with col2:
        ...
        header = f"Multivac Machinery  Knowledge Base Search: Find the answers you need, fast."
...
st.markdown('---')
input = st.text_input("You are talking to an AI, ask any question about Multivac Machinery .", key="input", on_change=handle_input)
